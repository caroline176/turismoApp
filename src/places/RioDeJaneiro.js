  ...
  return (
    <View style={StylesConteudo.container}>
      <View style={StylesConteudo.introduçao}>
        ...
        <View style={StylesConteudo.header}>
          ...
          <View style={StylesConteudo.rigthHeader}>
            <Image
              source={require("../assets/images/cristo2.png")}
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <View style={StylesConteudo.BodyScroll}>
            ...
            <Image
              ...
              source={require("../assets/images/rj2.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj3.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj4.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj5.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj6.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj7.png")}
            />
            <Image
              style={StylesConteudo.ImgCarossel}
              source={require("../assets/images/rj8.png")}
            />
          </View>
        </ScrollView>
      </View>
      ...
      <Modal visible={vis}>
        ...
        >
          <ImageBackground
            source={require("../assets/images/rj9.png")}
